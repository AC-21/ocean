...
if (
  !electronMain.includes("show: false") ||
  !electronMain.includes("setActivationPolicy(\"regular\")") ||
  !electronMain.includes("revealMainWindow") ||
  !electronMain.includes("window.center()") ||
  !electronMain.includes("window.moveTop()") ||
  !electronMain.includes("did-finish-load") ||
  !electronMain.includes("did-fail-load") ||
  !electronMain.includes("app.focus({ steal: true })") ||
  !electronMain.includes("revealFallbacks")
) {
...
if (!packageJson.includes("\"fluid:experimental-live-grid\"") || !packageJson.includes("src/fluid/fluidExperimentalLiveGrid.report.ts")) {
  errors.push("package.json must expose the FG-39 experimental live-grid command");
}

if (!tracking.includes("FG-39-T03") || !tracking.includes("FG-39-experimental-live-grid-2026-06-08.json") || !tracking.includes("https://github.com/AC-21/ocean/issues/42")) {
  errors.push("docs/TRACKING.md must record FG-39 experimental live-grid evidence and issue mapping");
}

if (
  !contract.includes("FG-39") ||
  !contract.includes("G-FG-39") ||
  !contract.includes("Experimental high-resolution live renderer gate") ||
  !contract.includes("npm run fluid:experimental-live-grid")
) {
  errors.push("fluidGridContract.ts must define the FG-39 experimental live-grid milestone, gate, and evidence command");
}
...
if (
  !oceanPhysicsApp.includes("experimentalFluidGridDimensionsFromSearch") ||
  !oceanPhysicsApp.includes("data-fluid-runtime-grid-override") ||
  !oceanPhysicsApp.includes("__fluidRuntimeGridOverride") ||
  !oceanPhysicsApp.includes("createFluidWaterRenderer(canvas, fluidCapability.selectedTier, { gridDimensions")
) {
  errors.push("OceanPhysicsApp.tsx must parse, expose, and pass the FG-39 runtime grid override into the live renderer");
}

if (!waterRenderer.includes("FluidWaterRendererOptions") || !waterRenderer.includes("gridDimensions: options.gridDimensions")) {
  errors.push("fluidWaterRenderer.ts must accept runtime grid dimensions for the FG-39 live renderer path");
}

if (!viteEnv.includes("__fluidRuntimeGridOverride")) {
  errors.push("vite-env.d.ts must expose the FG-39 runtime grid override global");
}

if (
  !experimentalLiveGrid.includes("G-FG-39") ||
  !experimentalLiveGrid.includes("1024") ||
  !experimentalLiveGrid.includes("576") ||
  !experimentalLiveGrid.includes("capability grid") ||
  !experimentalLiveGrid.includes("live renderer grid") ||
  !experimentalLiveGrid.includes("full-grid readback") ||
  !experimentalLiveGrid.includes("particlesActiveSeen")
) {
  errors.push("fluidExperimentalLiveGrid.ts must define FG-39 live-grid, capability-grid, smoothness, particle, and no-readback checks");
}

if (
  !experimentalLiveGridReport.includes("OCEAN_LAB_EXPERIMENTAL_FLUID_GRID") ||
  !experimentalLiveGridReport.includes("OCEAN_LAB_EXPERIMENTAL_LIVE_GRID_OUT") ||
  !experimentalLiveGridReport.includes("OCEAN_LAB_FLUID_TIER") ||
  !experimentalLiveGridReport.includes("data-water-grid") ||
  !experimentalLiveGridReport.includes("1024x576") ||
  !experimentalLiveGridReport.includes("data-water-pressure-readback") ||
  !experimentalLiveGridReport.includes("data-water-particles-readback") ||
  !experimentalLiveGridReport.includes("G-FG-39")
) {
  errors.push("fluidExperimentalLiveGrid.report.ts must launch the packaged app with the experimental grid flag and sample live WebGPU pacing/no-readback telemetry");
}

if (
  !experimentalLiveGridTest.includes("packaged ultra renderer") ||
  !experimentalLiveGridTest.includes("runtime grid override") ||
  !experimentalLiveGridTest.includes("full-grid readback") ||
  !experimentalLiveGridTest.includes("particle inactivity") ||
  !experimentalLiveGridTest.includes("G-FG-39")
) {
  errors.push("fluidExperimentalLiveGrid.test.ts must cover FG-39 pass and failure cases");
}

if (
  !oceanPhysicsAppTest.includes("benchmark-approved experimental runtime grids") ||
  !oceanPhysicsAppTest.includes("experimentalFluidGridDimensionsFromSearch") ||
  !oceanPhysicsAppTest.includes("4096x4096")
) {
  errors.push("OceanPhysicsApp.test.tsx must cover FG-39 experimental grid URL parsing");
}

if (
  !remap.includes("FG-39") ||
  !remap.includes("experimental live grid") ||
  !remap.includes("1024 x 576") ||
  !remap.includes("default calibrated capability selection remains capped at `768 x 432`") ||
  !remap.includes("OCEAN_LAB_EXPERIMENTAL_FLUID_GRID") ||
  !remap.includes("no full-grid readback")
) {
  errors.push("docs/FLUID_GRID_REMAP.md must summarize the FG-39 experimental live-grid gate and evidence");
}

if (
  !fg39Evidence.includes("\"gate\": \"G-FG-39\"") ||
  !fg39Evidence.includes("\"pass\": true") ||
  !fg39Evidence.includes("\"failures\": []") ||
  !fg39Evidence.includes("\"launchMode\": \"packaged-app\"") ||
  !fg39Evidence.includes("\"preferredTier\": \"ultra\"") ||
  !fg39Evidence.includes("\"selectedTier\": \"ultra\"") ||
  !fg39Evidence.includes("\"capabilityGrid\"") ||
  !fg39Evidence.includes("\"cellsX\": 768") ||
  !fg39Evidence.includes("\"runtimeGrid\"") ||
  !fg39Evidence.includes("\"cellsX\": 1024") ||
  !fg39Evidence.includes("\"cellsY\": 576") ||
  !fg39Evidence.includes("\"observedRuntimeGrid\": \"1024x576\"") ||
  !fg39Evidence.includes("\"runtimeGridOverride\": \"1024x576\"") ||
  !fg39Evidence.includes("\"renderer\": \"webgpu-grid-primary-v1\"") ||
  !fg39Evidence.includes("\"waterContext\": \"webgpu\"") ||
  !fg39Evidence.includes("\"pressureActiveSeen\": true") ||
  !fg39Evidence.includes("\"couplingActiveSeen\": true") ||
  !fg39Evidence.includes("\"particlesActiveSeen\": true") ||
  !fg39Evidence.includes("\"pressureNoFullGridReadback\": true") ||
...
if (
  !packageJson.includes("\"fluid:installed-high-resolution-operator-readout\"") ||
  !packageJson.includes("src/fluid/fluidInstalledHighResolutionOperatorReadout.report.ts")
) {
  errors.push("package.json must expose the FG-45 installed high-resolution operator readout command");
}

if (
  !tracking.includes("FG-45-T03") ||
  !tracking.includes("FG-45-installed-high-resolution-operator-readout-2026-06-08.json") ||
  !tracking.includes("https://github.com/AC-21/ocean/issues/48") ||
  !tracking.includes("visible preset and Drop controls")
) {
  errors.push("docs/TRACKING.md must record FG-45 installed high-resolution operator readout evidence and issue mapping");
}

if (
  !contract.includes("FG-45") ||
  !contract.includes("G-FG-45") ||
  !contract.includes("Installed high-resolution operator readout gate") ||
  !contract.includes("npm run fluid:installed-high-resolution-operator-readout") ||
  !contract.includes("visible preset and Drop controls") ||
  !contract.includes("Float Result, Float Timing, impact, splash")
) {
  errors.push("fluidGridContract.ts must define the FG-45 installed high-resolution operator readout milestone, gate, and visible readout proof");
}

if (
  !installedHighResolutionOperatorReadout.includes("G-FG-45") ||
  !installedHighResolutionOperatorReadout.includes("operator-foam-float-readout") ||
  !installedHighResolutionOperatorReadout.includes("operator-concrete-sink-readout") ||
  !installedHighResolutionOperatorReadout.includes("operator-leaky-drum-waterlogging-readout") ||
  !installedHighResolutionOperatorReadout.includes("clickedDrop") ||
  !installedHighResolutionOperatorReadout.includes("visible Float Result was empty") ||
  !installedHighResolutionOperatorReadout.includes("operator samples used canvas grids") ||
  !installedHighResolutionOperatorReadout.includes("particle path used full-grid readback")
) {
  errors.push("fluidInstalledHighResolutionOperatorReadout.ts must define FG-45 visible control, readout, outcome, WebGPU, pacing, and no-readback checks");
}

if (
  !installedHighResolutionOperatorReadoutReport.includes("OCEAN_LAB_INSTALLED_HIGH_RESOLUTION_OPERATOR_READOUT_OUT") ||
  !installedHighResolutionOperatorReadoutReport.includes("docs/evidence/FG-44-installed-high-resolution-desktop-visibility-2026-06-08.json") ||
  !installedHighResolutionOperatorReadoutReport.includes("getByRole(\"button\", { exact: true, name: scenario.presetName })") ||
  !installedHighResolutionOperatorReadoutReport.includes("getByRole(\"button\", { exact: true, name: \"Drop\" })") ||
  !installedHighResolutionOperatorReadoutReport.includes("readOperatorReadouts") ||
  !installedHighResolutionOperatorReadoutReport.includes("collectOperatorSamples") ||
  !installedHighResolutionOperatorReadoutReport.includes("G-FG-45")
) {
  errors.push("fluidInstalledHighResolutionOperatorReadout.report.ts must consume FG-44 evidence, click visible operator controls, collect samples, and scrape readouts");
}

if (
  !installedHighResolutionOperatorReadoutTest.includes("installed high-resolution operator readout gate") ||
  !installedHighResolutionOperatorReadoutTest.includes("visible controls and readouts") ||
  !installedHighResolutionOperatorReadoutTest.includes("API-only scenario") ||
  !installedHighResolutionOperatorReadoutTest.includes("stale operator readouts") ||
  !installedHighResolutionOperatorReadoutTest.includes("Canvas fallback")
) {
  errors.push("fluidInstalledHighResolutionOperatorReadout.test.ts must cover FG-45 pass and operator/readout/fallback failure cases");
}

if (
  !remap.includes("FG-45") ||
  !remap.includes("Installed high-resolution operator readout evidence") ||
  !remap.includes("operator-facing loop") ||
  !remap.includes("visible `Drop`") ||
  !remap.includes("what happened and how long") ||
  !remap.includes("Installed high-resolution operator readouts")
) {
  errors.push("docs/FLUID_GRID_REMAP.md must summarize the FG-45 operator-facing readout gate and evidence");
}

if (
  !fg45Evidence.includes("\"gate\": \"G-FG-45\"") ||
  !fg45Evidence.includes("\"pass\": true") ||
  !fg45Evidence.includes("\"failures\": []") ||
  !fg45Evidence.includes("\"gate\": \"G-FG-44\"") ||
  !fg45Evidence.includes("\"liveGrid\": \"1024x576\"") ||
  !fg45Evidence.includes("\"renderer\": \"webgpu-grid-primary-v1\"") ||
  !fg45Evidence.includes("\"waterContext\": \"webgpu\"") ||
  !fg45Evidence.includes("\"scenarioCount\": 3") ||
  !fg45Evidence.includes("\"operator-foam-float-readout\"") ||
  !fg45Evidence.includes("\"operator-concrete-sink-readout\"") ||
  !fg45Evidence.includes("\"operator-leaky-drum-waterlogging-readout\"") ||
  !fg45Evidence.includes("\"clickedPreset\": true") ||
  !fg45Evidence.includes("\"clickedDrop\": true") ||
  !fg45Evidence.includes("\"floats-indefinitely\"") ||
  !fg45Evidence.includes("\"sinks-immediately\"") ||
  !fg45Evidence.includes("\"waterlogs-then-sinks\"") ||
  !fg45Evidence.includes("\"floatResult\"") ||
  !fg45Evidence.includes("\"predictedSink\"") ||
  !fg45Evidence.includes("\"splash\"") ||
  !fg45Evidence.includes("\"canvasGrid\": \"1024x576\"") ||
  !fg45Evidence.includes("\"pressureNoFullGridReadback\": true") ||
...
if (
  !packageJson.includes("\"fluid:installed-high-resolution-visual-watchdog\"") ||
  !packageJson.includes("src/fluid/fluidInstalledHighResolutionVisualWatchdog.report.ts")
) {
  errors.push("package.json must expose the FG-47 installed high-resolution visual watchdog command");
}

if (
  !tracking.includes("FG-47-T03") ||
  !tracking.includes("FG-47-installed-high-resolution-visual-watchdog-2026-06-08.json") ||
  !tracking.includes("https://github.com/AC-21/ocean/issues/50") ||
  !tracking.includes("black, flat, stale, fallback")
) {
  errors.push("docs/TRACKING.md must record FG-47 installed high-resolution visual watchdog evidence and issue mapping");
}

if (
  !contract.includes("FG-47") ||
  !contract.includes("G-FG-47") ||
  !contract.includes("Installed high-resolution visual watchdog gate") ||
  !contract.includes("npm run fluid:installed-high-resolution-visual-watchdog") ||
  !contract.includes("black, flat, stale, fallback") ||
  !contract.includes("advancing water frames")
) {
  errors.push("fluidGridContract.ts must define the FG-47 installed high-resolution visual watchdog milestone, gate, and visual proof");
}

if (
  !installedHighResolutionVisualWatchdog.includes("G-FG-47") ||
  !installedHighResolutionVisualWatchdog.includes("minUniqueWaterFrames") ||
  !installedHighResolutionVisualWatchdog.includes("screen may be black") ||
  !installedHighResolutionVisualWatchdog.includes("screen may be flat") ||
  !installedHighResolutionVisualWatchdog.includes("frames may be stale") ||
  !installedHighResolutionVisualWatchdog.includes("UI-only visual")
) {
  errors.push("fluidInstalledHighResolutionVisualWatchdog.ts must define FG-47 black, flat, stale, fallback, and UI-only visual checks");
}

if (
  !installedHighResolutionVisualWatchdogReport.includes("OCEAN_LAB_INSTALLED_HIGH_RESOLUTION_VISUAL_WATCHDOG_OUT") ||
  !installedHighResolutionVisualWatchdogReport.includes("FG-46-installed-high-resolution-residual-budget-2026-06-08.json") ||
  !installedHighResolutionVisualWatchdogReport.includes("summarizePngPixels") ||
  !installedHighResolutionVisualWatchdogReport.includes("idle-1") ||
  !installedHighResolutionVisualWatchdogReport.includes("post-drop-3") ||
  !installedHighResolutionVisualWatchdogReport.includes("getByRole(\"button\", { exact: true, name: \"Drop\" })") ||
  !installedHighResolutionVisualWatchdogReport.includes("G-FG-47")
) {
  errors.push("fluidInstalledHighResolutionVisualWatchdog.report.ts must consume FG-46 evidence, capture idle/post-drop pixel probes, and write the FG-47 watchdog report");
}

if (
  !installedHighResolutionVisualWatchdogTest.includes("installed high-resolution visual watchdog gate") ||
  !installedHighResolutionVisualWatchdogTest.includes("black or flat") ||
  !installedHighResolutionVisualWatchdogTest.includes("stale watchdog samples") ||
  !installedHighResolutionVisualWatchdogTest.includes("fallback runtime grids") ||
  !installedHighResolutionVisualWatchdogTest.includes("weak FG-46 source residual provenance")
) {
  errors.push("fluidInstalledHighResolutionVisualWatchdog.test.ts must cover FG-47 pass and black/flat/stale/fallback/source failure cases");
}

if (
  !visualPixelProbe.includes("summarizePngPixels") ||
  !visualPixelProbe.includes("colorBuckets") ||
  !visualPixelProbe.includes("averageLuma") ||
  !visualPixelProbe.includes("opaqueSamples") ||
  !visualPixelProbe.includes("Unsupported PNG filter")
) {
  errors.push("fluidVisualPixelProbe.ts must expose reusable PNG pixel-probe decoding for FG-47");
}

if (
  !remap.includes("FG-47") ||
  !remap.includes("Installed high-resolution visual watchdog evidence") ||
  !remap.includes("burst watchdog") ||
  !remap.includes("black, flat, stale, fallback") ||
  !remap.includes("water-frame counter") ||
  !remap.includes("post-drop")
) {
  errors.push("docs/FLUID_GRID_REMAP.md must summarize the FG-47 visual watchdog gate and evidence");
}

if (
  !fg47Evidence.includes("\"gate\": \"G-FG-47\"") ||
  !fg47Evidence.includes("\"pass\": true") ||
  !fg47Evidence.includes("\"failures\": []") ||
  !fg47Evidence.includes("FG-46-installed-high-resolution-residual-budget-2026-06-08.json") ||
  !fg47Evidence.includes("\"gate\": \"G-FG-46\"") ||
  !fg47Evidence.includes("\"liveGrid\": \"1024x576\"") ||
  !fg47Evidence.includes("\"renderer\": \"webgpu-grid-primary-v1\"") ||
  !fg47Evidence.includes("\"waterContext\": \"webgpu\"") ||
  !fg47Evidence.includes("\"sampleCount\": 6") ||
  !fg47Evidence.includes("\"idle-1\"") ||
  !fg47Evidence.includes("\"post-drop-3\"") ||
  !fg47Evidence.includes("\"status\": \"nonblank\"") ||
  !fg47Evidence.includes("\"variety\": \"varied\"") ||
  !fg47Evidence.includes("\"waterFrameDelta\"") ||
  !fg47Evidence.includes("\"postDropActivePhysicsSeen\": true") ||
  !fg47Evidence.includes("\"pressureNoFullGridReadback\": true") ||
